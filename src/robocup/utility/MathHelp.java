...
public class MathHelp {
	 ...
	 * 
	 * @param r
	 *            the length of the Polar arm
	 * @param t
	 *            the angle, in degrees, of the arm from the x-axis
	 ...
	 * 
	 * @param p
	 *            The polar coordinates you want to convert
	 ...
	 * 
	 * @param x
	 *            the x coordinate of the Cartesian vector
	 * @param y
	 *            the y coordinate of the Cartesian vector
	 ...
	 * 
	 * This is just a wrapper, so you can pass in a Pos instead of extracting
	 * it's x and y and passing them in.
	 * 
	 * @param p
	...
	/**
	 * Magnitude Calculates the Magnitude of a vector, same as r in a Polar
	 * vector
	 * 
	 * @param p
	 *            the Pos of the vector
	 ...
	 * 
	 * @param p
	 *            the vector to find the normal of
	 ...
	 * 
	 * @param effort
	 *            From the stamina in the SenseMemory
	 * @param power
	...
	/**
	 * A calculator for power needed to get to a position on the field. This is
	 * derived from the Movement Model equations in the Server Manual: section
	 * 4.4
	 * 
	 * @param p
	...
	public static double getDashPower(Position p, double vel_r, double vel_t, double effort, double stamina) {
		...
		/*
		 * Polar vel = new Polar(vel_r, vel_t); getPos(vel).print(
		 * "Velocity Pos: "); vel.print("Velocity Polar: "); p.print(
		 * "Go to Pos: "); pt.print("Go to Polar: "); System.out.println(
		 * "Power: " + power);
		 */
	...
	/**
	 * A method to find the ball's next point given it's velocity and position
	 * relative to player.
	 * 
	 * @param ball
	 * @return A Polar coordinate with the theoretical position of the ball at
	 *         time t+1
	 */
	...
	/**
	 * A method to find an opponent's next point given his velocity and position
	 * relative to the player.
	 * 
	 * @param opponent
	 *            An ObjPlayer object representing the opponent to track
	 * @return A Polar coordinate with the predicted position of the opponent at
	 *         time t+1
	 */
	...
	/**
	 * Calculates the power needed to kick the ball to a specified place on the
	 * field, using the equation from the manual
	 * 
	 * @param p
	 *            A polar coordinate to kick the ball to
	 * @param vel_r
	 *            The magnitude of the player's velocity
	 * @param vel_t
	 *            the direction of the player's velocity
	 * @param ball_r
	 *            the distance of the ball to the player
	 * @param ball_t
	 *            the direction of the ball to the player
	 * 
